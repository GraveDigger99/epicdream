(() => {
    ...
    const tabsInfoBtns = document.querySelectorAll(".tabs-info__btn");
    const tabsInfoContent = document.querySelectorAll(".tabs-info__content");
    const script_select = document.querySelector(".tabs-info__select");
    if (tabsInfo) tabsInfo.addEventListener("click", (e => {
        if (e.target.classList.contains("tabs-info__btn")) {
    ...
    const tabsHandler = path => {
        tabsInfoBtns.forEach((element => {
            element.classList.remove("tabs-info__btn_active");
        }));
        document.querySelector(`[data-tabs-path = "${path}"]`).classList.add("tabs-info__btn_active");
        tabsInfoContent.forEach((element => {
            element.classList.remove("tabs-info__content_active");
        }));
        document.querySelector(`[data-tabs-target = "${path}"]`).classList.add("tabs-info__content_active");
    };
    script_select.onchange = () => {
        tabsInfo.querySelector(".tabs-info__content_active").classList.remove("tabs-info__content_active");
        tabsInfo.querySelectorAll(".tabs-info__content")[script_select.options.selectedIndex].classList.add("tabs-info__content_active");
    };
    window["FLS"] = false;
    isWebp();
    menuInit();
